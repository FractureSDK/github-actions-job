...
public class WorldgenCryptoRandom extends WorldgenRandom {
    ...
    public WorldgenCryptoRandom(int x, int z, Globals.@Nullable Salt typeSalt, long salt) {
        super(dev.vospek.leviathan.config.modules.opt.FastRNG.enabled ? new dev.vospek.leviathan.util.math.random.FasterRandomSource(0L) : new LegacyRandomSource(0L));
        if (typeSalt != null) {
