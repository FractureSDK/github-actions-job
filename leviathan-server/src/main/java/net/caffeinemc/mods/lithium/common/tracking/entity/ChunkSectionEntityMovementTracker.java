...
public abstract class ChunkSectionEntityMovementTracker {
    ...
    public static void unregister(ChunkSectionEntityMovementTracker @NotNull [] trackers) { // Leviathan - Replace Lithium tracker list with array
    ...
    public static boolean isUnchangedSince(long lastCheckedTime, ChunkSectionEntityMovementTracker @NotNull [] trackers) { // Leviathan - Replace Lithium tracker list with array
        for (ChunkSectionEntityMovementTracker tracker : trackers) {
    ...
    public static void listenToEntityMovementOnce(ChunkSectionEntityMovementListener listener, ChunkSectionEntityMovementTracker @NotNull [] trackers) { // Leviathan - Replace Lithium tracker list with array
        for (ChunkSectionEntityMovementTracker tracker : trackers) {
