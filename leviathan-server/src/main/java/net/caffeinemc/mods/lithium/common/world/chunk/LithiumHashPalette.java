// Leviathan - Lithium - faster hash palette
...
public final class LithiumHashPalette<T> extends HashMapPalette<T> implements Palette<T>, FastPalette<T> {
    ...
    // Leviathan start - Sync moonrise changes
    @Override
    public T[] moonrise$getRawPalette(final FastPaletteData<T> container) {
        return this.entries;
    }
    // Leviathan end - Sync moonrise changes
    ...
    // Leviathan start - override getEntries
    @Override
    public List<T> getEntries() {
        T[] copy = Arrays.copyOf(this.entries, this.size);
        return Arrays.asList(copy);
    }
    // Leviathan end - override getEntries
