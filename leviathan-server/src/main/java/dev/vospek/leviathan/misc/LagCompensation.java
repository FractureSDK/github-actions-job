package dev.vospek.leviathan.misc;
...
public class LagCompensation {
    ...
    public static int fluidDelay(Level level, BlockPos pos, int rawDelay, boolean enabledForThisFluid, TagKey<Fluid> oppositeTag) {
        return dev.vospek.leviathan.config.modules.misc.LagCompensation.enabled && enabledForThisFluid && !isTouchingFluid(level, pos, oppositeTag)
            ? tt20(rawDelay, true)
            : rawDelay;
    }
