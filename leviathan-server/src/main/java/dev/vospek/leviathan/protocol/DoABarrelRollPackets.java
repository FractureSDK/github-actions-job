...
public class DoABarrelRollPackets {
    ...
    private static <T extends LeviathanCustomPayload> LeviathanCustomPayload.Type<T> createType(String path) {
        return new LeviathanCustomPayload.Type<>(Identifier.fromNamespaceAndPath(DoABarrelRollProtocol.NAMESPACE, path));
    }

    public record ConfigResponseC2SPacket(int protocolVersion, boolean success) implements LeviathanCustomPayload {
    ...
    ) implements LeviathanCustomPayload {
    ...
    public record ConfigUpdateAckS2CPacket(int protocolVersion, boolean success) implements LeviathanCustomPayload {
    ...
    public record ConfigUpdateC2SPacket(int protocolVersion, ModConfigServer config) implements LeviathanCustomPayload {
    ...
    public record RollSyncC2SPacket(boolean rolling, float roll) implements LeviathanCustomPayload {
    ...
    public record RollSyncS2CPacket(int entityId, boolean rolling, float roll) implements LeviathanCustomPayload {
