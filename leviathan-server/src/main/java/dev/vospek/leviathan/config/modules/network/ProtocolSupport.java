...
import dev.vospek.leviathan.protocol.DoABarrelRollPackets;
import dev.vospek.leviathan.protocol.DoABarrelRollProtocol;
...
public class ProtocolSupport extends ConfigModule {
    ...
    public static int xaeroMapServerID = ThreadLocalRandom.current().nextInt(); // Leviathan - Faster Random
