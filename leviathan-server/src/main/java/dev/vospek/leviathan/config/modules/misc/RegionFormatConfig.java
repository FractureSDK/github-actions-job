...
import dev.vospek.leviathan.config.annotations.DoNotLoad;
import dev.vospek.leviathan.config.annotations.HotReloadUnsupported;
...
public class RegionFormatConfig extends ConfigModule {
    ...
    public static boolean isReadOnlyMode() {
        return LeviathanConstants.LINEAR_V2_READ_ONLY && regionFormat == EnumRegionFormat.LINEAR_V2;
    }
    ...
    public void onLoaded() {
        globalConfig.addCommentRegionBased(basePath(), """
                ...
                Read Leviathan docs before using!""",
            """
        ...
        if (regionFormat == EnumRegionFormat.LINEAR_V2) {
            ...
            if (isReadOnlyMode()) {
                ...
                LOGGER.error("then remove the JVM flag: -D{}=true", LeviathanConstants.LINEAR_V2_READ_ONLY_FLAG);
                LOGGER.error("============================================================");
            }
