package dev.vospek.leviathan.async;
...
import dev.vospek.leviathan.config.modules.opt.VirtualThreadSupport;
...
public class ExecutorFactory {
    ...
    public static ExecutorService buildChatExecutor() {
        // Leviathan start - Virtual thread support for chat executor
        ...
        // Leviathan end - Virtual thread support for chat executor
    ...
    public static ExecutorService buildDownloadPoolExecutor() {
        // Leviathan start - Virtual thread support for download pool
        ...
        // Leviathan end - Virtual thread support for download pool
    ...
    public static ExecutorService buildBukkitAsyncSchedulerExecutor() {
        // Leviathan start - Virtual thread support for bukkit async scheduler
        ...
        // Leviathan end - Virtual thread support for bukkit async scheduler
    ...
    public static ExecutorService buildFoliaAsyncSchedulerExecutor() {
        // Leviathan start - Virtual thread support for folia async scheduler
        ...
        // Leviathan end - Virtual thread support for folia async scheduler
