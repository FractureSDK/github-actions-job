...
import dev.vospek.leviathan.config.modules.async.AsyncPathfinding;
...
public class AsyncPathProcessor {
    ...
    private static final String THREAD_PREFIX = "Leviathan Async Pathfinding";
    ...
    private static RejectedExecutionHandler getRejectedPolicy() {
        return (Runnable rejectedTask, ThreadPoolExecutor executor) -> {
            ...
            if (System.currentTimeMillis() - lastWarnMillis > 30000L) {
                LOGGER.warn("Async pathfinding processor is busy! Pathfinding tasks will be treated as policy defined in config. Increasing max-threads in Leviathan config may help.");
