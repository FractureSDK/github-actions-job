...
public final class ReloadCommand extends PermissionedLeviathanSubcommand {
    ...
    public static final String LITERAL_ARGUMENT = "reload";
    ...
    private void doGaleReload(final CommandSender sender) {
        Command.broadcastCommandMessage(
            sender, Component.text("Reloading Gale config...", NamedTextColor.GREEN));
    ...
    private void doLeviathanReload(final CommandSender sender) {
        Command.broadcastCommandMessage(
            sender, Component.text("Reloading Leviathan config...", NamedTextColor.GREEN));
